        ...
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-gray-500 mt-1 text-sm">
                    Easily toggle between activating and deactivating companies to manage their access and visibility.
                </p>
            </div>
                    ...
                    },
                    {
                        ...
                        render: (admin: IAdmin) => (
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <p className="font-medium text-gray-900 text-sm">{admin?.contactPerson?.name || 'N/A'}</p>
                                    <p className="text-xs text-gray-500 flex items-center gap-1">
                                        <svg className="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                                        </svg>
                                        {admin?.contactPerson?.phone || 'N/A'}
                                    </p>
                                </div>
                            </div>
                        )
                    ...
                    },
                    {
                        ...
                        render: (admin: IAdmin) => (
                            <div className="flex items-center gap-1">
                                ...
                                <Link
                                    to={`/company-management/${admin.id || admin._id}`}
                                    className="p-2 text-[#475467] hover:text-primary hover:bg-gray-100 rounded-lg transition-colors"
                                    title="View Details"
                                >
                                    <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
